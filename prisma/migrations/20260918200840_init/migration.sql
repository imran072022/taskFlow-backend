...
-- CreateEnum
CREATE TYPE "InvitationStatus" AS ENUM ('REQUESTED', 'ACCEPTED', 'REJECTED');
...
-- CreateEnum
CREATE TYPE "ActivityAction" AS ENUM ('PROJECT_CREATED', 'MEMBER_ADDED', 'MEMBER_REMOVED', 'MEMBER_PROMOTED', 'MEMBER_DEMOTED', 'TASK_CREATED', 'TASK_ASSIGNED', 'TASK_UNASSIGNED', 'TASK_STATUS_CHANGED');
...
CREATE TABLE "OrganizationInvitation" (
    ...
    "status" "InvitationStatus" NOT NULL DEFAULT 'REQUESTED',
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "Conversation_managerId_key" ON "Conversation"("managerId");
...
-- CreateIndex
CREATE INDEX "OrganizationInvitation_inviteeId_idx" ON "OrganizationInvitation"("inviteeId");
